...
def get_time_completo(time_id, rodada, is_live):
    """Retorna o JSON completo do time (incluindo capitão)"""
...
def main():
    ...
    if not is_live:
        ...
        if rodada_alvo <= ultima_bq: print(f"zzz Dados já existem."); return
    ...
    for id_atl, dados in dict_atletas_pts.items():
        ...
        pos_id = str(dados.get('posicao_id', '')) # Tenta pegar do payload de pontos
    ...
    for time_obj in times_liga:
        ...
        for atl in atletas:
            ...
            l_esc.append({
                ...
                'pontos': pts, 
                'is_capitao': bool(eh_capitao), # <--- NOVA COLUNA
                'status_rodada': tipo_dado, 'timestamp': ts_agora
            })
    ...
    if l_atl:
        ...
        s_atl = [bigquery.SchemaField("rodada", "INTEGER"), bigquery.SchemaField("atleta_id", "INTEGER"),
                 ...
                 bigquery.SchemaField("atleta_posicao", "STRING"), # <--- Schema Novo
    ...
    if l_esc:
        ...
        s_esc = [bigquery.SchemaField("rodada", "INTEGER"), bigquery.SchemaField("liga_time_nome", "STRING"),
                 ...
                 bigquery.SchemaField("is_capitao", "BOOLEAN"), # <--- Schema Novo
